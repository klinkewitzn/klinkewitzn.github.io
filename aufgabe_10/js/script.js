...
function drawListToDOM() {
    ...
    var _loop_1 = function (index_1) {
         ...
         */
        todo.innerHTML = "<span class='check " + todos[index_1].checked + "'><i class='fas fa-check'></i></span>" // es wird entweder true oder false hingeschrieben(klasse kann amn stylen)
            + todos[index_1].text +
...
function addTodo() {
     ...
     */
    if (inputDOMElement.value != "") { //schauen ob es leer is, wenn ja dann nicht ausführen
        /**
        ...
        todos.unshift(addtoDotask_1); //setzt neuen Eintrag an Anfang des Arrays
...
function toggleCheckState(index) {
     ...
     * wird wieder getriggert
     */
    drawListToDOM(); //alles nur in Typeskript, diese Funktion schreibt alles nochmal neu
}
/**
