...
function drawListToDOM() {
    ...
    var loop = function (indexloop) {
         ...
         */
        todo.innerHTML = "<span class='check " + todos.checked[indexloop] + "'><i class='fas fa-check'></i></span>"
            + todos.text[indexloop] +
